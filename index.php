...
<body>
    ...
    $arrayMulheres = [
        ...
        ['Marissa Mayer', 'marissa-mayer1.png', 'Engenheira de software de destaque, foi a primeira engenheira mulher do Google, onde liderou o desenvolvimento de produtos icônicos como a Busca e o Gmail. Mais tarde, atuou como CEO do Yahoo!, tornando-se uma das executivas mais influentes do Vale do Silício.']
    ];
    ?>
